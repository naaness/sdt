...
<html lang="es">
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <?php foreach ($page->items as $item) { ?>
            <tr>
                <td><a href="<?php echo $this->url->get(); ?>posts/view/<?php echo $item->id; ?>"><?php echo $this->escaper->escapeJs($this->escaper->escapeHtml($item->name)); ?></a></td>
                ...
                <td><?php echo $item->count_views; ?></td>
                <td><?php echo $item->count_answers; ?></td>
                <?php if ($item->user_id == $user_id) { ?>
                    <td>
                        <a href="<?php echo $this->url->get(); ?>posts/edit/<?php echo $item->id; ?>"><button class="btn btn-default">Editar</button></a>
                        &nbsp;
                        <a href="<?php echo $this->url->get(); ?>posts/delete/<?php echo $item->id; ?>"><button class="btn btn-default">Eliminar</button></a>
                    </td>
                <?php } else { ?>
                    <td>
        ...
        <tr>
            <td colspan="5">
                <div align="center">
                    <?php echo $this->tag->linkTo(array('Posts/index', '<i class="glyphicon glyphicon-fast-backward"></i> Primera', 'class' => 'btn btn-default')); ?>
                    <?php echo $this->tag->linkTo(array('Posts/index/?page=' . $page->before, '<i class="glyphicon glyphicon-backward"></i> Anterior', 'class' => 'btn btn-default')); ?>
                    <?php echo $this->tag->linkTo(array('Posts/index/?page=' . $page->next, 'Siguiente <i class="glyphicon glyphicon-forward"></i>', 'class' => 'btn btn-default')); ?>
                    <?php echo $this->tag->linkTo(array('Posts/index/?page=' . $page->last, 'Ultimo <i class="glyphicon glyphicon-fast-forward"></i>', 'class' => 'btn btn-default')); ?>
    ...
    <a href="<?php echo $this->url->get(); ?>posts/add"><button class="form-control btn btn-default">Crear Foro</button></a>
