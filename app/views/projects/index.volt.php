...
<html lang="es">
    ...
    <h1 class="text-center"><?php echo $this->escaper->escapeHtml($this->escaper->escapeJs($team->name)); ?></h1><hr>
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <?php foreach ($page->items as $item) { ?>
            <tr>
                <td><a href="<?php echo $this->url->get(); ?>tasks/index/<?php echo $team_id; ?>/<?php echo $item->id; ?>"><?php echo $this->escaper->escapeHtml($this->escaper->escapeJs($item->name)); ?></a></td>
                <td><?php if ($item->status == 1) { ?><span class="label label-success">Activo</span><?php } else { ?><span class="label label-danger">Eliminado</span><?php } ?></td>
                <?php if ($item->user_id == $user_id && $item->status) { ?>
                    <td>
                        <a href="<?php echo $this->url->get(); ?>projects/edit/<?php echo $team_id; ?>/<?php echo $item->id; ?>"><button class="btn btn-default">Editar</button></a>
                        &nbsp;
                        <a href="<?php echo $this->url->get(); ?>projects/delete/<?php echo $team_id; ?>/<?php echo $item->id; ?>"><button class="btn btn-default">Eliminar</button></a>
                    </td>
                <?php } else { ?>
                    <td>
        ...
        <tr>
            <td colspan="4">
                <div align="center">
                    <?php echo $this->tag->linkTo(array('projects/index/' . $team_id, '<i class="glyphicon glyphicon-fast-backward"></i> Primera', 'class' => 'btn btn-default')); ?>
                    <?php echo $this->tag->linkTo(array('projects/index/' . $team_id . '?page=' . $page->before, '<i class="glyphicon glyphicon-backward"></i> Anterior', 'class' => 'btn btn-default')); ?>
                    Página <?php echo $page->current; ?> de <?php echo $page->total_pages; ?>
                    <?php echo $this->tag->linkTo(array('projects/index/' . $team_id . '?page=' . $page->next, 'Siguiente <i class="glyphicon glyphicon-forward"></i>', 'class' => 'btn btn-default')); ?>
                    <?php echo $this->tag->linkTo(array('projects/index/' . $team_id . '?page=' . $page->last, 'Ultimo <i class="glyphicon glyphicon-fast-forward"></i>', 'class' => 'btn btn-default')); ?>
    ...
    <?php if ($canCreate) { ?>
    <a href="<?php echo $this->url->get(); ?>projects/add/<?php echo $team_id; ?>"><button class="form-control btn btn-default">Crear Proyecto</button></a>
    <?php } ?>
