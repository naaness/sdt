...
<html lang="es">
    ...
    <?php echo $cosas; ?>
    <div class="jumbotron">
        <h1 id="hello,-world!">Hola<?php echo $this->escaper->escapeJs($this->escaper->escapeHtml($username)); ?>!, Bienvenido a SDT<a class="anchorjs-link" href="#hello,-world!"><span class="anchorjs-icon"></span></a></h1>
        <p>Esta es una plataforma que le ayudara a gestionar mejor su tiempo y a obtener una mayor productividad.</p>
        <?php if (!$v_session) { ?>
            <p><a class="btn btn-primary btn-lg" href="<?php echo $this->url->get(); ?>login" role="button">Ingresa Aqui</a></p>
        <?php } ?>
    </div>
    <?php if ($v_session) { ?>
        <h3>Usa las siguientes herramientas</h3>
        <div class="list-group">
            <a href="<?php echo $this->url->get(); ?>rmregistries" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> <strong>RM</strong> : Registro Maestro.</a>
            <a href="<?php echo $this->url->get(); ?>checklist" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>  <strong>Checklist</strong> : Listado de tareas</a>
            <a href="<?php echo $this->url->get(); ?>htd" class="list-group-item"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> <strong>HTD</strong> : Hoja de Trabajo diario.</a>
        </div>
    <?php } ?>
