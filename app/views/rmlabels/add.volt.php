...
<h1 class="text-center">Crear Etiqueta</h1><hr>

<?php echo $this->tag->form(array('rmlabels/add/', 'method' => 'post', 'class' => 'smart-form', 'role' => 'form')); ?>
    ...
    <div class="form-group">
        ...
        <label id="example1" style="color: #000000; background-color: rgb(133, 133, 132);">123. abc. DEF. GHI</label>&nbsp;
        <label id="example2" style="color: #000000; background-color: rgb(233, 233, 232);">123. abc. DEF. GHI</label><br/>
