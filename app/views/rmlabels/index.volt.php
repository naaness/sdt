...
<html lang="es">
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <?php foreach ($page->items as $item) { ?>
            <tr>
                <td><a href="<?php echo $this->url->get(); ?>rmlabels/edit/<?php echo $item->id; ?>"><?php echo $item->name; ?></a></td>
                <td><div style="color: <?php echo $item->color; ?>;background-color: <?php echo $item->b_color; ?>;font-family: <?php echo $item->rmFonts->name; ?>">Abcd..</div></td>
                <td><div style="color: <?php echo $item->color; ?>;background-color: <?php echo $item->b_color_checked; ?>; font-family: <?php echo $item->rmFonts->name; ?>">Abcd..</div></td>
                <td>
                    <a href="<?php echo $this->url->get(); ?>rmlabels/edit/<?php echo $item->id; ?>"><button class="btn btn-default">Editar</button></a>
                    &nbsp;
                    <a href="<?php echo $this->url->get(); ?>rmlabels/delete/<?php echo $item->id; ?>"><button class="btn btn-default">Eliminar</button></a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
        ...
        <tr>
            <td colspan="4">
                <div align="center">
                    <?php echo $this->tag->linkTo(array('rmlabels/', '<i class="glyphicon glyphicon-fast-backward"></i> Primera', 'class' => 'btn btn-default')); ?>
                    <?php echo $this->tag->linkTo(array('rmlabels/?page=' . $page->before, '<i class="glyphicon glyphicon-backward"></i> Anterior', 'class' => 'btn btn-default')); ?>
                    <?php echo $this->tag->linkTo(array('rmlabels/?page=' . $page->next, 'Siguiente <i class="glyphicon glyphicon-forward"></i>', 'class' => 'btn btn-default')); ?>
                    <?php echo $this->tag->linkTo(array('rmlabels/?page=' . $page->last, 'Ultimo <i class="glyphicon glyphicon-fast-forward"></i>', 'class' => 'btn btn-default')); ?>
    ...
    <a href="<?php echo $this->url->get(); ?>rmlabels/add"><button class="form-control btn btn-default">Crear una Etiqueta</button></a>
