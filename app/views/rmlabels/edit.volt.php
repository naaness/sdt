...
<html lang="es">
    ...
    <?php echo $this->tag->form(array('rmlabels/edit/', 'method' => 'post', 'class' => 'smart-form', 'role' => 'form')); ?>
    ...
    <div class="form-group">
        <?php echo $form->render('color'); ?>
    </div>
    <div class="form-group">
        <?php echo $form->render('b_color'); ?>
    </div>
    <div class="form-group">
        <?php echo $form->render('b_color_checked'); ?>
    </div>
    <div class="form-group">
        <label for="example">Colores de la Etiqueta</label><br>
        <label id="example1" style="color: <?php echo $label->color; ?>; background-color:<?php echo $label->b_color; ?>">123. abc. DEF. GHI</label>&nbsp;
        <label id="example2" style="color: <?php echo $label->color; ?>; background-color:<?php echo $label->b_color_checked; ?>">123. abc. DEF. GHI</label><br/>
    ...
    <div class="form-group">
        <?php echo $form->label('rm_font_id'); ?>
        <?php echo $form->render('rm_font_id'); ?>
    </div>
    <div class="form-group">
        <?php echo $form->label('rm_size_id'); ?>
        <?php echo $form->render('rm_size_id'); ?>
    </div>
    <div class="form-group">
