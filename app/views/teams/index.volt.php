...
<html lang="es">
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <?php foreach ($page->items as $item) { ?>
            <tr>
                <td><a href="<?php echo $this->url->get(); ?>teams/view/<?php echo $item->id; ?>"><?php echo $item->name; ?></a></td>
                ...
                <td>
                    <?php if ($item->leader_id == $user_id) { ?>
                            <a href="<?php echo $this->url->get(); ?>teams/edit/<?php echo $item->id; ?>"><button class="btn btn-default">Editar</button></a>
                            &nbsp;
                            <a href="<?php echo $this->url->get(); ?>teams/delete/<?php echo $item->id; ?>"><button class="btn btn-default">Eliminar</button></a>
                        </td>
                    <?php } else { ?>
        ...
        <tr>
            <td colspan="4">
                <div align="center">
                    <?php echo $this->tag->linkTo(array('teams/', '<i class="glyphicon glyphicon-fast-backward"></i> Primera', 'class' => 'btn btn-default')); ?>
                    <?php echo $this->tag->linkTo(array('teams/?page=' . $page->before, '<i class="glyphicon glyphicon-backward"></i> Anterior', 'class' => 'btn btn-default')); ?>
                    Página <?php echo $page->current; ?> de <?php echo $page->total_pages; ?>
                    <?php echo $this->tag->linkTo(array('teams/?page=' . $page->next, 'Siguiente <i class="glyphicon glyphicon-forward"></i>', 'class' => 'btn btn-default')); ?>
                    <?php echo $this->tag->linkTo(array('teams/?page=' . $page->last, 'Ultimo <i class="glyphicon glyphicon-fast-forward"></i>', 'class' => 'btn btn-default')); ?>
                </div>
            </td>
        <tr>
        </tbody>
    </table>
    <a href="<?php echo $this->url->get(); ?>teams/add"><button class="form-control btn btn-default">Crear un Equipo de trabajo</button></a>
